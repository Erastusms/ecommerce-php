...
$query = mysqli_query($koneksi, "SELECT p.*, k.kota, k.tarif, u.nama
                                    FROM pesanan p 
                                    JOIN user u ON p.user_id = u.user_id 
                                    JOIN kota k ON k.kota_id=p.kota_id 
